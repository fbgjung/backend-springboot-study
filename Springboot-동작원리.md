# 8,9,10,11,12,13,14강 - 스프링부트 동작원리
...
![springboot-1](https://github.com/fbgjung/backend-springboot-study/assets/166492522/ba840e96-3808-4b6f-8521-46b629438b1d)
...
![springboot-4](https://github.com/fbgjung/backend-springboot-study/assets/166492522/ccc8748b-d337-4de1-a968-b3aa167fc521)
...
![springboot-2](https://github.com/fbgjung/backend-springboot-study/assets/166492522/6de6d5ba-71dd-4620-8572-4a45731dfcfd)
...
[2] 클라이언트 : 최초 요청이 아닐 때 (Re -Request)
		...
		(2) 서블릿 객체 <재사용!> ㅡ ㅡ ㅡ ㅡ ㅡ ㅡ ㅡ ㅡ ㅡ ㅡ ㅡ ㅡ ㅡ ㅡ ㅡ ㅡ ㅡ ㅡ ㅡ ㅡ ㅡ ㅡ ㅡ ㅡ ㅡ ㅡ ㅡ ㅡ ㅡ ㅡ ㅡ ㅡ ㅡ 
		|
		|		(2-1) 스레드2 생성 
		|					(2-2-1) Service() : 서비스 호출 
		|								(-> Post, Get, Put, Delete)
		...
		|		(2-3) get() : DB연결, 데이터 응답 등 
		|
		 ㅡ ㅡ ㅡ ㅡ ㅡ ㅡ ㅡ ㅡ ㅡ ㅡ ㅡ ㅡ ㅡ ㅡ ㅡ ㅡ ㅡ ㅡ ㅡ ㅡ ㅡ ㅡ ㅡ ㅡ ㅡ ㅡ ㅡ ㅡ ㅡ ㅡ ㅡ ㅡ ㅡ ㅡ ㅡ ㅡ ㅡ ㅡ ㅡ ㅡ ㅡ ㅡ
```
...
src - libraries - **WebContent (Web-INF)**
    ...
    ![springboot-3](https://github.com/fbgjung/backend-springboot-study/assets/166492522/de899589-2091-4d47-bc37-db4ab3aa8891)
